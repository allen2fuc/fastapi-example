...
class UserCreate(UserBase):
    role_ids: Annotated[list[int], Field(description="角色ID列表")] = []
...
class UserUpdate(BaseModel):
    email: Annotated[EmailStr | None, Field(description="邮箱")] = None
    password: Annotated[SecretStr | None, Field(description="密码")] = None
    is_active: Annotated[bool | None, Field(description="是否激活")] = None
